        ...
        <div class="relative z-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div class="text-center mb-16 animate-fade-in">
                    <h1 class="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6 animate-scale-in">
                ...
                <div class="grid md:grid-cols-3 gap-8 mb-16">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 transform hover:scale-105 transition duration-300 animate-slide-down">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-6">
                            Створюйте заявки на ремонт, обирайте досвідчених майстрів та відстежуйте статус виконання робіт.
                        </p>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 transform hover:scale-105 transition duration-300 animate-slide-down" style="animation-delay: 0.1s;">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-6">
                            Отримуйте замовлення, будуйте репутацію та розвивайте свій бізнес з нашою платформою.
                        </p>
                        <ul class="space-y-3 text-gray-600 dark:text-gray-400">
                            <li class="flex items-center">
                                <svg class="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 transform hover:scale-105 transition duration-300 animate-slide-down" style="animation-delay: 0.2s;">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Безпека</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-6">
                            Захист даних, перевірені майстри та прозора система відгуків для вашого спокою.
                        </p>
                        <ul class="space-y-3 text-gray-600 dark:text-gray-400">
                            <li class="flex items-center">
                                <svg class="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
