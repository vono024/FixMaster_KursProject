                ...
                @auth
                    <div class="hidden md:flex md:ml-10 md:space-x-4">
                        ...
                        @if(auth()->user()->role === 'admin')
                            ...
                            <a href="{{ route('reports.statistics') }}" class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-gray-700 transition">
                                Звіти
                            </a>
                        @endif
